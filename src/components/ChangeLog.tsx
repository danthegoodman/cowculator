  ...
  return (
    <div>
      ...
      <div>
        ...
        <ul>
          <li>Added persistence for settings after reload.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>
            Removed the Historical Market tab due to issues with the amount of
            data it was trying to load
          </li>
          <li>
            The selected tab is now included in the URL, which allows the back
            button to work in the app
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>
            Forked from{" "}
            <a href="https://github.com/MWISim/cowculator">
              github.com/MWISim/cowculator
            </a>
          </li>
